    ...
    public static class UserDataAccess
    {
        public static void AddUser(User user)
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                var creditLimitParameter = new SqlParameter("@CrediteLimit", SqlDbType.Int) { Value = user.CreditLimit };
                command.Parameters.Add(creditLimitParameter);
                var clientIdPararameter = new SqlParameter("@ClientId", SqlDbType.Int) { Value = user.Client.Id };
                command.Parameters.Add(clientIdPararameter);
